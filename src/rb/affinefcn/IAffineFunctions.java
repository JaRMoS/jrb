 ...
 * 
 * @todo generalize/separate to single IAffineCoefficients-Interface of JaRMoSBase
 * 
 * @author Daniel Wirtz
 * @date Aug 28, 2011
 * 
...
public interface IAffineFunctions {
	 ...
	 * The time parameter has to be passed every time anyways, but computations can be made mode efficient if the
	 * matrices stay identical for all time-steps
	 * 
	...
	/**
	 * Flag that tells JRB if the bilinear form/input functional affine theta coefficient functions are time-dependent
	 * or not. The time parameter has to be passed every time anyways, but computations can be made mode efficient if
	 * the matrices stay identical for all time-steps
	 * 
